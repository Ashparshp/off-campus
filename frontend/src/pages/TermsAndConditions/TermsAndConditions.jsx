  ...
  return (
    <div className="margin container">
      ...
      <p className="text-white md:mx-40 mt-10">
        ...
        <br /> <br />
        <span className="text-xl font-[600]">SECTION 1 – ONLINE STORE TERMS</span>
        <br /> <br />
        ...
        <br /> <br />
        <span className="text-xl font-[600]">SECTION 2 – GENERAL CONDITIONS </span>
        <br /> <br />
        ...
        <br /> <br />
        <span className="text-xl font-[600]">SECTION 3 – ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATION</span>
        <br /> <br />
        ...
        site.
        <br /> <br />
        <span className="text-xl font-[600]">SECTION 4 – MODIFICATIONS TO THE SERVICE AND PRICES</span>
        <br /> <br />
        ...
        <br /> <br />
        <span className="text-xl font-[600]">SECTION 5 – PRODUCTS OR SERVICES</span>
        <br /> <br />
        ...
        are subject to return or exchange only according to our Cancellations &
        Return Policy.
        <br /> <br />
        ...
        <br /> <br />
        All decisions for refunds, cancellations, returns, rescheduling and any
        other modification to the payment or provision of services are up to the
        discretion of the mentor and off-campus. All decisions made by
        off-campus are final and binding.
        <br /> <br />
        <span className="text-xl font-[600]">SECTION 6 – ACCURACY OF BILLING AND ACCOUNT INFORMATION</span>
        <br /> <br />
        ...
        <br /> <br />
        For more detail, please review our Cancellations & Returns Policy.
        <br /> <br />
        <span className="text-xl font-[600]">SECTION 7 – OPTIONAL TOOLS</span>
        <br /> <br />
        ...
        Service.
        <br /> <br />
        <span className="text-xl font-[600]">SECTION 8 – THIRD-PARTY LINKS</span>
        <br /> <br />
        ...
        third-party.
        <br /> <br />
        Any use of third party logos and company/brand names does not imply any
        affiliation with or endorsement by said third party.
        <br /> <br />
        <span className="text-xl font-[600]">SECTION 9 – USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS</span>
        <br /> <br />
        ...
        <br /> <br />
        <span className="text-xl font-[600]">SECTION 10 – PERSONAL INFORMATION</span>
        <br /> <br />
        Your submission of personal information through the store is governed by
        our Privacy Policy.
        <br /> <br />
        <span className="text-xl font-[600]">SECTION 11 – ERRORS, INACCURACIES AND OMISSIONS</span>
        <br /> <br />
        ...
        <br /> <br />
        <span className="text-xl font-[600]">SECTION 12 – PROHIBITED USES</span>
        <br /> <br />
        ...
        <br /> <br />
        <span className="text-xl font-[600]">SECTION 13 – DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY</span>
        <br /> <br />
        ...
        <br /> <br />
        In no case shall off-campus, our directors, officers, employees,
        ...
        permitted by law.
        <br /> <br />
        <span className="text-xl font-[600]">SECTION 14 – INDEMNIFICATION</span>
        <br /> <br />
        You agree to indemnify, defend and hold harmless off-campus and our
        ...
        a third-party.
        <br /> <br />
        <span className="text-xl font-[600]">SECTION 15 – SEVERABILITY</span>
        <br /> <br />
        ...
        <br /> <br />
        <span className="text-xl font-[600]">SECTION 16 – TERMINATION</span>
        <br /> <br />
        ...
        thereof).
        <br /> <br />
        <span className="text-xl font-[600]">SECTION 17 – ENTIRE AGREEMENT</span>
        <br /> <br />
        ...
        <br /> <br />
        <span className="text-xl font-[600]">SECTION 18 – GOVERNING LAW</span>
        <br /> <br />
        These Terms of Service and any separate agreements whereby we provide
        you Services shall be governed by and construed in accordance with the
        laws of India and jurisdiction of Delhi.
        <br /> <br />
        <span className="text-xl font-[600]">SECTION 19 – CHANGES TO TERMS OF SERVICE</span>
        <br /> <br />
        ...
        <br /> <br />
        <span className="text-xl font-[600]">SECTION 20 – CONTACT INFORMATION</span>
        <br /> <br />
        Questions about the Terms of Service should be sent to us at
        charchitkurra3@gmail.com
      </p>
    </div>
  );
};
